    ...
    <div class="min-h-screen grid lg:grid-cols-2">
        <div class="flex items-center justify-center p-8 bg-surface-0">
            <div class="w-full max-w-md space-y-8">
                <form class="space-y-6" @submit.prevent="authStore.login(authStore.credentials)">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="email" v-model="authStore.credentials.email" type="email" required
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <a href="#" class="text-sm font-medium text-primary-600 hover:text-primary-500">Forgot
                                    password?</a>
                            </div>
                            <div class="relative">
                                <span
                                ...
                                <input id="password" v-model="authStore.credentials.password" type="password" required
                                    class="block w-full pl-10 pr-3 py-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-slate-900 placeholder-slate-400 transition-colors"
                                    placeholder="••••••••" />
                            </div>
                        </div>
                    ...
                    <button type="submit"
                        class="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all hover:shadow-md transform active:scale-[0.99]">
                        Sign in
                    </button>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <button type="button"
                            ...
                            <Icon name="carbon:logo-github" class="mr-2" /> GitHub
                        </button>
                    </div>
                </form>
                <p class="text-center text-sm text-slate-600">
                    ...
                    <NuxtLink to="/register"
                        class="font-medium text-primary-600 hover:text-primary-500 hover:underline">Sign up for free
                    </NuxtLink>
                </p>
            </div>
        </div>
        <div class="hidden lg:block relative bg-slate-900 overflow-hidden">
            ...
            <img src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop"
                alt="Background" class="absolute inset-0 w-full h-full object-cover opacity-50" />
            <div class="absolute inset-0 flex flex-col justify-end p-12 z-20 text-white">
                <blockquote class="space-y-4">
                    <p class="text-lg font-medium italic">
                        "This project management tool has completely transformed how our team operates. The clarity and
                        efficiency we've gained is unmatched."
                    </p>
                    <footer class="text-sm font-medium text-slate-300">— Sofia Davis, Product Manager</footer>
                </blockquote>
            </div>
        </div>
    </div>
...
onMounted(() => {
    google.accounts.id.initialize({
        client_id: '620120064825-j6o60f73ej9rj7raabj0v0qle3jesc7m.apps.googleusercontent.com',
