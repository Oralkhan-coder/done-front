<template>
    <div class="min-h-screen grid lg:grid-cols-2">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="fullName" v-model="registrationData.fullName" type="text" required
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="password" v-model="registrationData.password" type="password" required
                                    minlength="6"
                                    class="block w-full pl-10 pr-3 py-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-slate-900 placeholder-slate-400 transition-colors"
                                    placeholder="••••••••" />
                            </div>
        ...
        <div class="hidden lg:block relative bg-slate-900 overflow-hidden">
            ...
            <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2564&auto=format&fit=crop"
